...
void lineMenu()
{
    ...
    switch(pilih){
        case 1:
            ...
            cin>>mode;
            drawLine(x1, y1, x2, y2, 1, tebal, mode, colors);
            back();
            break;
        case 2:
            cout<<"Enter x1,y1,x2,y2"<<endl;
            ...
            cout<<"Mode Ketebalan (in/out) : ";
            cin>>mode;
            drawLine(x1, y1, x2, y2, 2, tebal, mode, colors);
            back();
            break;
        case 3:
            cout<<"Enter x1,y1,x2,y2"<<endl;
            ...
            cout<<"Mode Ketebalan (in/out) : ";
            cin>>mode;
            drawLine(x1, y1, x2, y2, 3, tebal, mode, colors);
            back();
            break;
        case 4:
            cout<<"Enter x1,y1,x2,y2"<<endl;
            ...
            cout<<"Mode Ketebalan (in/out) : ";
            cin>>mode;
            drawLine(x1, y1, x2, y2, 4, tebal, mode, colors);
            back();
            break;
        default:
            mainMenu();
...
void shapeMenu(){
    ...
    switch(pilih){
        case 1:
        {
            ...
            cin>>panjang;
            drawPersegi(x,y,panjang,panjang,false);
            back();
            break;
        }
        case 2:
        {
            ...
            cout<<"Lebar  : ";
            cin>>lebar;
            drawPersegi(x,y,panjang,lebar,false);
            back();
            break;
        }
        case 3:
        {
            ...
            cin>>tinggi;
            drawJajarGenjang(x,y,panjang,tinggi,false);
            back();
            break;
        }
        case 4:
...
//            translasiTitik(P, T);
        ...
        case 2:
        {
            ...
            drawLine(P[0][0], P[0][1], P[1][0], P[1][1], 1, 1, "in", 1);
